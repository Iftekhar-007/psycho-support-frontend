...
//       <span
//         className="pointer-events-none absolute left-0 top-0 h-0 w-0 rounded-tl-2xl border-l-4 border-t-4 border-[#8FAF9F] transition-all duration-500 ease-out group-hover:h-full group-hover:w-full"
//         aria-hidden="true"
//       />
//       {/* Corner border: bottom-right */}
//       <span
//         className="pointer-events-none absolute bottom-0 right-0 h-0 w-0 rounded-br-2xl border-b-4 border-r-4 border-[#8FAF9F] transition-all duration-500 ease-out group-hover:h-full group-hover:w-full"
//         aria-hidden="true"
//       />
//     </div>
//   );
...
//             </p>
//             {/* <div className="mt-2 grid w-full grid-cols-2 gap-6 border-t border-border pt-6 sm:grid-cols-3">
//               <div>
//                 <p className="text-2xl font-semibold text-[#0f1f1c] sm:text-3xl">
//                   12+
//                 </p>
